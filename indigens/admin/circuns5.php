...
<meta charset="UTF-8">
    ...
    <title>Listado circunscripcion 5</title>
...
<body>
	...
	<main class="table">
        <section class="table__header">
            <h1>Listado circunscripcion 5</h1>
        ...
        <section class="table__body">
            <table>
				...
				<?php 
				$sql="SELECT * from usuarios where estado in ('Colima', 'Hidalgo', 'México', 'Michoacan') order by estado";
