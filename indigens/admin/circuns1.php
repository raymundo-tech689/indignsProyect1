...
<meta charset="UTF-8">
    ...
    <title>Listado circunscripcion 1</title>
...
<body>
	...
	<main class="table">
        <section class="table__header">
            <h1>Listado circunscripcion 1</h1>
        ...
        <section class="table__body">
            <table>
                <thead>
                    <tr>
                        <th> Estado <span class="icon-arrow"></span></th>
                        <th> Nombre <span class="icon-arrow"></span></th>
                        <th> Apellido paterno <span class="icon-arrow"></span></th>
                        <th> Apellido materno <span class="icon-arrow"></span></th>
                        <th> Email <span class="icon-arrow"></span></th>
                        <th> Telefono <span class="icon-arrow"></span></th>
				...
				<?php 
				$sql="SELECT * from usuarios where estado in ('Baja California', 'Baja California sur', 'Chihuahua', 'Durango', 'Jalisco', 'Nayarit', 'Sinaloa', 'Sonora') order by estado";
