...
<meta charset="UTF-8">
    ...
    <title>Listado circunscripcion 2</title>
...
<body>
	...
	<main class="table">
        <section class="table__header">
            <h1>Listado circunscripcion 2</h1>
        ...
        <section class="table__body">
            <table>
				...
				<?php 
				$sql="SELECT * from usuarios where estado in ('Aguascalientes', 'Coahuila', 'Guanajuato', 'Nuevo León', 'Querétaro', 'San Luis Potosí', 'Tamaulipas', 'Zacatecas') order by estado";
