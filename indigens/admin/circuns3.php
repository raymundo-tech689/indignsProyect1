...
<meta charset="UTF-8">
    ...
    <title>Listado circunscripcion 3</title>
...
<body>
	...
	<main class="table">
        <section class="table__header">
            <h1>Listado circunscripcion 3</h1>
        ...
        <section class="table__body">
            <table>
				...
				<?php 
				$sql="SELECT * from usuarios where estado in  ('Campeche', 'Chiapas', 'Oaxaca', 'Quintana Roo', 'Tabasco', 'Veracruz', 'Yucatán') order by estado";
