...
<meta charset="UTF-8">
    ...
    <title>Listado circunscripcion 4</title>
...
<body>
	...
	<main class="table">
        <section class="table__header">
            <h1>Listado circunscripcion 4</h1>
        ...
        <section class="table__body">
            <table>
				...
				<?php 
				$sql="SELECT * from usuarios where estado in ('Ciudad de México', 'Guerrero', 'Morelos', 'Puebla', 'Tlaxcala') order by estado";
